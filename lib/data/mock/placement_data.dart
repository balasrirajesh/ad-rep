...
final List<PostModel> mockPosts = [
  PostModel(
    ...
    content: '🚀 To all 3rd year students: Start NOW. Not after exams. Not next semester. NOW. I see so many students saying "I\'ll start DSA after this exam." By the time you finish, your batch mate already solved 200 problems. LeetCode daily — even 1 problem — compounds over time.',
    type: 'advice',
  ...
  PostModel(
    ...
    content: '💡 UNPOPULAR TRUTH: Your first package does NOT define your career. I started at 3.5 LPA in 2018 at TCS. Today at Microsoft: 42 LPA. The gap between 7 LPA and 40 LPA is not talent — it\'s information + consistent skill building. Your first job is just the starting line, not the finish.',
    type: 'story',
  ...
  PostModel(
    ...
    content: '🤫 Anonymous confession: I cried for 3 days after my 8th placement rejection. I had 11 rejections total before getting placed. If you\'re struggling — you\'re NOT alone. Every rejection is data, not a verdict on your worth.',
    type: 'confession',
  ...
  PostModel(
    ...
    content: '🤖 ML is not magic. I built a SIMPLE logistic regression model to predict placement outcomes using our college\'s placement data. That ONE project got me placed at Mphasis at ₹7.5 LPA. Don\'t copy Kaggle notebooks. Solve REAL problems from your surroundings.',
    type: 'advice',
...
final List<QAModel> mockQA = [
  QAModel(
    id: 'q001',
    question: 'I am in 2nd year CSE with 6.8 CGPA. Should I focus on DSA or build web projects? I\'m confused about what companies actually want.',
    askedBy: 'Arjun Reddy',
    askedById: 's001',
  ...
  QAModel(
    id: 'q002',
    question: 'ECE student here, 3rd year. All my friends in CSE are getting IT placements. What should I do as an ECE student?',
  ...
  QAModel(
    id: 'q003',
    question: 'What is the minimum CGPA required for Amazon off-campus? I have 7.2 CGPA in CSE and already have 250+ LeetCode problems.',
  ...
  QAModel(
    id: 'q004',
    question: 'I want to learn Flutter and get placed in a company that works on mobile apps. What is the exact roadmap I should follow from scratch?',
  ...
  QAModel(
    id: 'q005',
    question: 'Is ServiceNow a good career option for CSE freshers? What certification should I start with and what salary can I expect?',
  ...
  QAModel(
    id: 'q006',
    question: 'How do I prepare for the Infosys InfyTQ and Smart Hiring assessment? What are the actual questions like?',
    askedBy: 'Pooja Devi',
    askedById: 's006',
  ...
  QAModel(
    id: 'q007',
    question: 'I want to get into AWS cloud. Should I go for Solutions Architect Associate or Cloud Practitioner first? I have zero cloud background.',
    askedBy: 'Dilip Kumar',
    askedById: 's007',
  ...
  QAModel(
    id: 'q008',
    question: 'What should my resume look like as a CSE fresher with no internship experience? I have done 2 college projects.',
  ...
  QAModel(
    id: 'q009',
    question: 'Is it worth doing MTech or should I just get placed? What are the long term salary differences?',
    askedBy: 'Teja Varma',
    askedById: 's009',
  ...
  QAModel(
    id: 'q010',
    question: 'I failed in 3 subjects in 2nd year and now have a backlog. Will companies reject me outright? Is placement still possible?',
  ...
  QAModel(
    id: 'q011',
    question: 'What is the difference between on-campus and off-campus placements? Is it worth applying off-campus if we don\'t get placed on campus?',
    askedBy: 'Kiran Teja',
    askedById: 's011',
  ...
  QAModel(
    id: 'q012',
    question: 'How important is GitHub for freshers in 2025? What should I put on my GitHub to make recruiters notice me?',
  ...
  QAModel(
    id: 'q013',
    question: 'Is learning React Native better or Flutter for mobile development? Which one has more job opportunities in India right now?',
    askedBy: 'Nikhil Goud',
    askedById: 's013',
  ...
  QAModel(
    id: 'q014',
    question: 'How do I crack the TCS NQT? What is the difficulty level of the coding section? I am a beginner in coding.',
    askedBy: 'Prasad Rao',
    askedById: 's014',
  ...
  QAModel(
    id: 'q015',
    question: 'What is the best way to prepare for system design interviews as a fresher? All resources I find are for experienced people.',
    askedBy: 'Varun Tej',
    askedById: 's015',
...
final List<EventModel> mockEvents = [
  EventModel(
    ...
    description: 'Ravi Kumar Reddy (SDE-1 at Amazon) will walk you through his entire preparation strategy — OA, coding rounds, and behavioral interviews.',
  ...
  EventModel(
    ...
    description: 'Ajay Kumar Thota (Senior SWE at Microsoft) conducts a 2-hour live workshop on designing scalable systems from scratch.',
  ...
  EventModel(
    ...
    description: 'Deepika Rao shares her journey from zero Flutter knowledge to getting placed at Groww in 6 months.',
  ...
  EventModel(
    ...
    description: 'Panel discussion with 3 AWS-certified alumni on real ROI, preparation strategy, and what companies actually pay for certified freshers.',
...
final List<BadgeModel> mockBadges = [
  BadgeModel(id: 'b001', title: 'First Connect', description: 'View your first alumni profile', icon: '🤝', isEarned: false, category: 'Social'),
  BadgeModel(id: 'b002', title: 'Curious Mind', description: 'Ask your first question in Q&A', icon: '❓', isEarned: false, category: 'Engagement'),
  BadgeModel(id: 'b003', title: 'Skill Seeker', description: 'Select your first career goal on roadmap', icon: '🎯', isEarned: false, category: 'Growth'),
  BadgeModel(id: 'b004', title: 'Event Goer', description: 'RSVP to your first alumni webinar', icon: '🎓', isEarned: false, category: 'Events'),
  BadgeModel(id: 'b005', title: 'Rising Star', description: 'Your question receives 10+ upvotes', icon: '⭐', isEarned: false, category: 'Community'),
  BadgeModel(id: 'b006', title: 'Explorer', description: 'Browse all 4 sections of the app', icon: '🗺️', isEarned: false, category: 'Exploration'),
  BadgeModel(id: 'b007', title: 'Network Builder', description: 'View 5 different alumni profiles', icon: '🌐', isEarned: false, category: 'Social'),
  BadgeModel(id: 'b008', title: 'Community Hero', description: 'Ask 5 questions in the Q&A community', icon: '💬', isEarned: false, category: 'Engagement'),
  BadgeModel(id: 'b009', title: 'Goal Setter', description: 'Complete your profile with name and bio', icon: '🏁', isEarned: false, category: 'Profile'),
  BadgeModel(id: 'b010', title: 'Placement Ready', description: 'Achieve a career score above 50', icon: '🚀', isEarned: false, category: 'Milestone'),
];

final Map<String, List<Map<String, dynamic>>> skillPackageData = {
  'CSE': [
    {'skill': 'DSA + LeetCode 300+', 'minPkg': 8.0, 'maxPkg': 45.0, 'count': 45},
    {'skill': 'Full Stack (React + Node)', 'minPkg': 6.0, 'maxPkg': 22.0, 'count': 32},
    {'skill': 'Flutter / Mobile Dev', 'minPkg': 5.5, 'maxPkg': 18.0, 'count': 18},
    {'skill': 'AWS Cloud Certified', 'minPkg': 7.0, 'maxPkg': 24.0, 'count': 14},
    {'skill': 'ServiceNow Admin', 'minPkg': 4.5, 'maxPkg': 12.0, 'count': 22},
    {'skill': 'Basic (Aptitude Only)', 'minPkg': 3.2, 'maxPkg': 7.0, 'count': 89},
  ],
  'ECE': [
    {'skill': 'Embedded Systems / VLSI', 'minPkg': 5.0, 'maxPkg': 16.0, 'count': 12},
    {'skill': 'IT Track (Python + SQL)', 'minPkg': 3.5, 'maxPkg': 9.0, 'count': 34},
    {'skill': 'IoT / Automation', 'minPkg': 4.0, 'maxPkg': 12.0, 'count': 8},
  ],
  'MECH': [
    {'skill': 'AutoCAD / SolidWorks', 'minPkg': 3.5, 'maxPkg': 8.0, 'count': 20},
    {'skill': 'IT Track (fresher coding)', 'minPkg': 3.2, 'maxPkg': 7.0, 'count': 15},
  ],
  'CIVIL': [
